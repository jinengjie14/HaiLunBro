    ...
    <div>
        ...
        <div v-if="have">
            <div class="form-horizontal setroom">
                ...
                <div class="form-group">
                    <label for="roomtitle" class="col-md-2 control-label">标题</label>
                    <div class="col-md-10">
                ...
                <div class="form-group">
                    <label for="roomnotice" class="col-md-2 control-label">房间公告</label>
                    <div class="col-md-10">
                        <div class="form-control-static roomnotice-show" data-edit-btn>{{ room.announcement }}</div>
                    </div>
                    <div class="col-md-10" style="display: none;" data-edit-input>
                        <div class="row">
                            <div class="col-md-10"><textarea id="roomnotice" class="form-control" rows="3" placeholder="暂无公告"></textarea></div>
                            <div class="col-md-2"><a href="javascript:;" class="btn btn-success">提交</a></div>
                        </div>
                    </div>
                </div>
                ...
                <div class="form-group">
                    <label class="col-md-2 control-label">rmtp推流地址</label>
                    <div class="col-md-10">
                        <p class="form-control-static" style="color: tomato">
                            rtmp://cdn.duimeng.org/live<br>
                ...
                <div class="form-group">
                    <label class="col-md-2 control-label">直播码</label>
                    <div class="col-md-10">
                        <p class="form-control-static" style="color: tomato">
                            {{ room.id }}
                        </p>
